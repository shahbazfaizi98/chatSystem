                        ...
                        <div class="bg-white shadow rounded-md dark:bg-gray-900 -mx-2 lg:mx-0">
                            ...
                            <div uk-lightbox>
                                <div class="grid grid-cols-2 gap-2 p-2">
                                    ...
                                    <a href="<?=ASSET_WEB_URL?>assets/images/post/img9.jpg" class="col-span-2">  
                                        <img src="<?=ASSET_WEB_URL?>assets/images/post/img9.jpg" alt="" class="rounded-md w-full lg:h-76 object-cover">
                                    </a>
                                    <a href="<?=ASSET_WEB_URL?>assets/images/post/img10.jpg">  
                                        <img src="<?=ASSET_WEB_URL?>assets/images/post/img10.jpg" alt="" class="rounded-md w-full h-full">
                                    </a>
                                    <a href="<?=ASSET_WEB_URL?>assets/images/post/img11.jpg" class="relative">  
                                        <img src="<?=ASSET_WEB_URL?>assets/images/post/img11.jpg" alt="" class="rounded-md w-full h-full">
                        ...
                        <div class="bg-white dark:bg-gray-900 shadow-md rounded-md overflow-hidden">
                            ...
                            <div class="divide-gray-300 divide-gray-50 divide-opacity-50 divide-y px-4 dark:divide-gray-800 dark:text-gray-100">
                                <div class="flex items-center justify-between py-3">
                                    <div class="flex flex-1 items-center space-x-4">
                                        <a href="profile.html">
                                            <img src="<?=ASSET_WEB_URL?>assets/images/avatars/avatar-2.jpg" class="bg-gray-200 rounded-full w-10 h-10">
                                        </a>
                                ...
                                <div class="flex items-center justify-between py-3">
                                    <div class="flex flex-1 items-center space-x-4">
                                        <a href="profile.html">
                                            <img src="<?=ASSET_WEB_URL?>assets/images/avatars/avatar-1.jpg" class="bg-gray-200 rounded-full w-10 h-10">
                                        </a>
                                        <div class="flex flex-col">
                                ...
                                <div class="flex items-center justify-between py-3">
                                    <div class="flex flex-1 items-center space-x-4">
                                        <a href="profile.html">
                                            <img src="<?=ASSET_WEB_URL?>assets/images/avatars/avatar-5.jpg" class="bg-gray-200 rounded-full w-10 h-10">
                                        </a>
                                        <div class="flex flex-col">
                                ...
                                <div class="flex items-center justify-between py-3">
                                    <div class="flex flex-1 items-center space-x-4">
                                        <a href="profile.html">
                                            <img src="<?=ASSET_WEB_URL?>assets/images/avatars/avatar-7.jpg" class="bg-gray-200 rounded-full w-10 h-10">
                                        </a>
                                        <div class="flex flex-col">
