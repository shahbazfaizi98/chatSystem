...
<!-- Mirrored from instelloo.netlify.app/chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 May 2023 14:56:58 GMT -->
    ...
    <div id="wrapper">
        ...
        <div class="main_content">
            ...
            <div class="container m-auto pt-5">
                ...
                <div class="lg:flex lg:shadow lg:bg-white lg:space-y-0 space-y-8 rounded-md lg:-mx-0 -mx-5 overflow-hidden dark:lg:bg-gray-800">
                    <!-- left message-->
